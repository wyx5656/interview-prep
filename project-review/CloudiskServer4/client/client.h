...
#define USER_NAME_DEFINE "please input your user name:\n"
#define PASSWORD_DEFINE "please input your password:\n"
#define PASSWORD_DEFINE_AGAIN "please input your password again:\n"
typedef enum {
    CMD_TYPE_PWD=1,
    CMD_TYPE_LS,
    CMD_TYPE_CD,
